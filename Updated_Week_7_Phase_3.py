...
#****************************************************************************************************************************
    ...
    with open(FILENAME, 'r') as EmpInfo:  
        while True:
...
if __name__ == "__main__":
        ...
        with open(FILENAME, 'a') as EmpInfo:
            ...
            while True:
                ...
                # write the line of code that will assign to EmpDetail a pipe delimited string of fromdate, todate, empname, hours, hourlyrat and taxrate and a carriage return at the end
                EmpDetail = fromdate + '|' + todate + '|' + empname + '|' + str(hours) + '|' + str(hourlyrate) + '|' + str(taxrate) + '\n'
                # write the line of code that will write EmpDetail to the file 
                EmpInfo.write(EmpDetail)
